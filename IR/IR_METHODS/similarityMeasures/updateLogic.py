...
def updateNode(sourceNode, destinationNode, medicalSimilarity=0):
    ...
    if sourceNode in utils.specialNucleotides:
        # Get all possible nucleotides of source
        sourceNodeValues = utils.specialNucleotidesRepresentations[sourceNode]
    else:
    ...
    if destinationNode in utils.specialNucleotides:
        # Get all possible nucleotides of destination
        destinationNodeValues = utils.specialNucleotidesRepresentations[destinationNode]
    else:
...
def updateNodeMedicalSimilarity(sourceNode, destinationNode):
    ...
    if sourceNode in utils.specialNucleotides and destinationNode in utils.specialNucleotides:
        return 1
    # If the source nucleotide is a special nucleotide
    if sourceNode in utils.specialNucleotides:
        # Get all possible nucleotides of source
